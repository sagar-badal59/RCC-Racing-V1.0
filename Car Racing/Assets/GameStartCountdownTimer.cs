...
using Photon.Pun;
    ...
    /// </remarks>
    public class GameStartCountdownTimer : MonoBehaviourPunCallbacks
    {
        /// <summary>
        ...
        public const string GameStartCountdownStartTime = "GameStartTime";
        ...
        Debug.Log("Emptying info text.", this.Text);
            ...
            props.Remove(GameStartCountdownStartTime);
        ...
        public static bool TryGetStartTime(out int startTimestamp)
        {
            ...
            if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey(GameStartCountdownStartTime) && PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue(GameStartCountdownStartTime, out startTimeFromProps))
            {
        ...
        public static void SetStartTime()
        {
            ...
            Hashtable props = new Hashtable
            {
                {GameStartCountdownStartTime, (int)PhotonNetwork.ServerTimestamp}
            };
            PhotonNetwork.CurrentRoom.SetCustomProperties(props);
